...
import com.github.tth05.teth.cli.commands.BytecodeCommand;
import com.github.tth05.teth.cli.commands.REPLCommand;
...
@CommandLine.Command(
        ...
        subcommands = {ASTCommand.class, BytecodeCommand.class, REPLCommand.class, RunCommand.class},
