...
public class AnchorSets {
    ...
    public static final AnchorSet BINARY_EXPRESSION_OPERATORS = new AnchorSet(List.of(
    ...
    public static final AnchorSet FIRST_SET_EXPRESSION = AnchorSet.union(FIRST_SET_PRIMARY_EXPRESSION, FIRST_SET_UNARY_EXPRESSION);
    ...
    public static final AnchorSet END_SET_PARENTHESISED_EXPRESSION = new AnchorSet(List.of(TokenType.R_PAREN));
    ...
    public static final AnchorSet FIRST_SET_STATEMENT_EXPRESSIONLESS = AnchorSet.union(FIRST_SET_BLOCK, FIRST_SET_KEYWORD_STATEMENT);
